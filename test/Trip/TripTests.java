...
class TripTests {
    @Test
    void testConvertToHours() throws ParseException {
    ...
    @Test
    void testTripDurationOfSingleDigit() throws ParseException {
    ...
    @Test
    void testTripDurationOfMultipleDigits() throws ParseException {
    ...
    @Test
    void testIsNotValidTooSlow() throws ParseException {
        LocalTime startTime = TripService.stringToTime("10:00");
        LocalTime endTime = TripService.stringToTime("15:00");
    ...
    @Test
    void testIsValidIfFive() throws ParseException {
    ...
    @Test
    void testIsNotValidTooFast() throws ParseException {
    ...
    @Test
    void testIsValidIfOneHundred() throws ParseException {
        LocalTime startTime = TripService.stringToTime("10:00");
        LocalTime endTime = TripService.stringToTime("15:00");
